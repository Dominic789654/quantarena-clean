# run-backtest-multipersonality-modes Specification

## Purpose
TBD - created by archiving change extract-run-backtest-and-multipersonality-modes. Update Purpose after archive.
## Requirements
