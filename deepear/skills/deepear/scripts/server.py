...
try:
    ...
    # Fallback for when run from within deepear directory
    try:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="DeepEar Analysis Skill Server")
    parser.add_argument(
        "--port",
        type=int,
        default=int(os.getenv("INSTANCE_PORT", 8001)),
        help="Server port (default: 8001, or INSTANCE_PORT env var)"
    )
    parser.add_argument(
        "--host",
        type=str,
    ...
    print(f"""
    ╔═══════════════════════════════════════════════════════════╗
    ║   DeepEar Skill Server                                   ║
    ╠═══════════════════════════════════════════════════════════╣
    ║  Instance ID: {instance_id:<47} ║
